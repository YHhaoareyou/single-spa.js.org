...
- [Vite single-spa TypeScript example](https://github.com/YHhaoareyou/vite-single-spa-ts-root-config) refers to the official example [Vite single-spa application](https://github.com/joeldenning/vite-single-spa-example) while written in TypeScript & with React example.  
  - [vite-single-spa-ts-root-config](https://github.com/YHhaoareyou/vite-single-spa-ts-root-config) is the root-config of a single-spa project having Vite applications, while the root-config itself is still run by Webpack.
  - [vite-single-spa-ts-vue-example](https://github.com/YHhaoareyou/vite-single-spa-ts-vue-example) is a Vue TypeScript single-spa app run by Vite.
  - [vite-single-spa-ts-react-example](https://github.com/YHhaoareyou/vite-single-spa-ts-react-example) is a React TypeScript single-spa app run by Vite.
